...
//     destination: (req, file, cb) => {
//         const uploadPath = path.join(__dirname, 'public', 'uploads', req.body.scheme, req.body.branch, req.body.semester, req.body.subject);
...
// // API endpoint to handle notes upload
// app.post('/api/upload-notes', notesUpload.single('notes_file'), async (req, res) => {
//     if (!req.file) {
...
//         res.status(500).json({ message: 'Failed to save notes information.', error: error.message }); // Include error message
//     }
// }, (error, req, res, next) => {
